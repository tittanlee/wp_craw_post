...
class bomb01:
  ...
  def __init__(self):
    self.base_url = "http://www.bomb01.com"
  ...
  def get_content(self, url):
    ...
    art_title = soup.find(class_ = "title").text
 ...
 # replace img class setting.
    if 'img' in content_string:
      for img in art_content.find_all('img'):
        ...
        img['src'] = self.base_url + img['src']



    # Remove ad
    for ad in art_content.find_all("div", id = re.compile('[aA][dD]')):
      ad.decompose()
