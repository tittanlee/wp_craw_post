...
class buzzhand(base_craw):
  def __init__(self, url):
    base_craw.__init__(self, url)
    self.img_server_url = 'http://www.buzzhand.com.tw/'
  ...
  def get_content(self, soup):
    ...
    art_content = soup.find('div', id='articleContent')
    ...
    # Remove another Ads
    for mid_post_ad in art_content.find_all('div', class_ = 'mid-post-ad'):
      mid_post_ad.decompose()
